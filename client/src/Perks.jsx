export default function Perks({selected,onChange}){
    ...
    <>
    {/*----------------------------------------------------------------------------------------------------------------------- */}
    <label className="font-semibold border p-4 flex rounded-2xl gap-2 items-center cursor-pointer " >
    ...
    <label className="font-semibold border p-4 flex rounded-2xl gap-2 items-center cursor-pointer " >
    <input type="checkbox" checked={selected.includes('free parking')} name="free parking" onChange={handlecheckbox}/>
    <span>
